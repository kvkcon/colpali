...
def main():
    ...
    device = get_torch_device("cuda:5")
    print(f"Device used: {device}")

    # Model name
    # model_name = "/data/hf_models/colqwen_backup/colqwen2-base"#"vidore/colqwen2-v0.1"#"/data/hf_models/colqwen2-v0.1"
    ...
    # peft_model_id = "/data/hf_models/colqwen_backup/colqwen2-v0.1"
    # # Load processor
    ...
    dataset = cast(Dataset, load_dataset("/data/hf_datasets/colpali_train_set/", split="test[:16]"))
